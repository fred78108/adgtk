...
from adgtk.data.records import create_records
from adgtk.common.exceptions import InvalidScenarioState
from .base import ProcessingFeatures
...
class CsvToDataStoreProcessor:
    ...
    blueprint: FactoryBlueprint = {
        ...
        "arguments": {
            ...
            "exclude_columns": ListArgumentSetting(
                default_value=[],
                argument_type=ArgumentType.LIST,
                help_str="The columns if any to exclude",
                list_arg_type=ArgumentType.STRING,
                list_arg_default_value=""),
            "include_columns": ListArgumentSetting(
                argument_type=ArgumentType.LIST,
                default_value=[],
                help_str="The columns if any to include",
                list_arg_type=ArgumentType.STRING,
                list_arg_default_value=""),
