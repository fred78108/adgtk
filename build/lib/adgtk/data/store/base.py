...
# TODO: turn into protocols for each??
@dataclass
class DataStoreFeatureFlags(ComponentFeatures):
    """Provides a consistent set of feature flags for any consumer"""
    search_options: Union[List[SearchOption], None]
    can_measure_size_directly: bool
    can_search_by_proximity: bool
    can_iterate: bool
    can_filter_searches: bool    
