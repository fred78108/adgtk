...
from adgtk.data.records.base import PresentableRecord, PresentableGroup
...
class GroupDataValueOverlap:
    ...
    def __init__(self, tracker_label: str = "g-data-value-overlap"):
        self.tracker_label = tracker_label
        self._meas = DataValueOverlap(tracker_label=tracker_label)
