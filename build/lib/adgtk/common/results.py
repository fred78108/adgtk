...
# TODO: create a function for result "listing" that covers both all
# experiments as well as the files using anytree
...
class FolderManager:
    ...
    def __init__(
        ...
        if not os.path.exists(exp_result_dir):
            ...
            logging.info(f"Existing {exp_result_dir} found. No action taken")
